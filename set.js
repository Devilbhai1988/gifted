...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Gifted~nzQVQAzR#4WCbXLQ0w2O8oAu6HkWhIIkwjTy0dIK-NXr5uMC0K4I", // Add sess Id here espwcially when deploying on panels else use app.json and .env file...
SUDO_NUMBERS: process.env.SUDO_NUMBERS || "+923225302306", //Add multiple Numbers with Country Codes without (+) Separated by Comma...
...
OWNER_NAME: process.env.OWNER_NAME || "Nabeel king", // Input Yours custom...(Maintain font for Flow)
